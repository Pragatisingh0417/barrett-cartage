                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl text-white text-center md:text-left">
                        ...
                        <motion.p
                            ...
                            IFlatbed Trucking Tailored to Industrial and Commercial Needs.

                           Custom Flatbed Freight Solutions for Your Cargo Needs.            </motion.p>
...
Our flatbed freight shipping service is built for oversized, heavy, or irregularly shaped cargo that won’t fit in enclosed trailers.  Whether you’re transporting steel beams, construction equipment, machinery, or large pipes, our open-deck trailers provide full access for top, side, and rear loading using cranes or forklifts.  We offer a range of flatbed trailer types - including 48 ft flatbeds, 40 ft step decks, 40 ft goosenecks to match your specific load requirements.  Every shipment is secured with DOT-compliant chains, straps, and tarps to ensure safety and prevent damage during transit.  With expertise in handling challenging freight, we deliver reliable, on-time performance across the U.S.                        </p>
             ...
             <div className="bg-gray-100 rounded-2xl p-6 shadow-sm">
                 ...
                 />
                     ...
                     <div>
                       <h2 className="text-3xl md:text-4xl font-bold mb-6">
Not Getting the Support You Need with Your Flatbed Freight Shipments?   </h2>
